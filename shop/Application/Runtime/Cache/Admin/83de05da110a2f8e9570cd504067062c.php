...
<form method="post" action="/ww/shop/index.php/Admin/Order/edit" name="listForm" onsubmit="return confirmSubmit(this)">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            <tbody>
                ...
                <tr>
                    <td><input type="text" name="order_id" value="<?php echo ($order["order_id"]); ?>"></td>
