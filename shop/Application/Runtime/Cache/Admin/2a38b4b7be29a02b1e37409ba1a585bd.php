...
<h1>
<span class="action-span"><a href="/ww/shop/index.php/Admin/Brand/add">添加品牌</a></span>
...
<div class="form-div">
  <form action="javascript:search_brand()" name="searchForm">
    <img src="<?php echo (ADMIN_PUBLIC); ?>/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH">
     <input type="text" name="brand_name" size="15" id="keyword">
...
<div class="list-div" id="listDiv">
  ...
  <table cellpadding="3" cellspacing="1">
    <tbody>
      ...
      '></td>
      <td align="center">
        <a href="/ww/shop/index.php/Admin/Brand/edit/id/<?php echo ($vo["brand_id"]); ?>" title="编辑">编辑</a> |
        <a href="/ww/shop/index.php/Admin/Brand/delete/id/<?php echo ($vo["brand_id"]); ?>" onclick="javascript:return confirm('你确认要删除吗？')" title="编辑">移除</a> 
      </td>
...
<script type="text/javascript">
  function search_brand() {
    ...
    window.location.href = "/ww/shop/index.php/Admin/Brand/index/id/"+keyword;
  }
</script>
</body>
</html>