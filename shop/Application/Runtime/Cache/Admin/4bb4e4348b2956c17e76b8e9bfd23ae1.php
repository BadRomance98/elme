...
<!--
var pic = new Image();
pic.src="<?php echo (ADMIN_PUBLIC); ?>/imagesarrow_right.gif";
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 10, *";
    imgArrow.src = "<?php echo (ADMIN_PUBLIC); ?>/imagesarrow_left.gif";
  }
  else
  {
    frmBody.cols="0, 10, *";
    imgArrow.src = "<?php echo (ADMIN_PUBLIC); ?>/imagesarrow_right.gif";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  <tr><td><a href="javascript:toggleMenu();"><<>></a></td></tr>
</table>
</body>
</html>