			...
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  ...
						  <li class="menu-item"><a href="/ww/shop/index.php/Admin/Category/index" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="/ww/shop/index.php/Admin/Brand/index" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="/ww/shop/index.php/Admin/Type/index" target="main-frame">商品类型</a></li>				
						  <li class="menu-item"><a href="/ww/shop/index.php/Admin/Goods/add" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="/ww/shop/index.php/Admin/Goods/index" target="main-frame">商品列表</a></li>
					</ul>
				</li>
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="/ww/shop/index.php/Admin/Order/index" target="main-frame">订单列表</a></li>
						<li class="menu-item"><a href="/ww/shop/index.php/Admin/Order/add" target="main-frame">添加订单</a></li>
					</ul>
				</li>
        <li class="explode" key="04_order" name="menu"> 用户管理        
          <ul style="display: block;">
            <li class="menu-item"><a href="/ww/shop/index.php/Admin/User/index" target="main-frame">用户列表</a></li>
            <li class="menu-item"><a href="/ww/shop/index.php/Admin/User/add" target="main-frame">添加用户</a></li>
          </ul>
        </li>	
			</ul>
		</div>
