...
<h1>
<span class="action-span"><a href="/ww/shop/index.php/Admin/Category/index">商品分类</a></span>
	 ...
	 <table width="100%" id="general-table">
		<tbody>
				...
				<td>
					<select name="parent_id">
						...
						<?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cat_id"]); ?>"
							<?php if($vo['cat_id'] == $cat['parent_id']): ?>selected='selected'<?php endif; ?>
							>
			...
			<tr>
				...
				<?php if($cat["is_show"] == 1): ?>checked='checked'<?php endif; ?>
				 > 是<input type="radio" name="is_show" value="0"
				<?php if($cat["is_show"] == 0): ?>checked='checked'<?php endif; ?>
				 > 否  </td>
			</tr>
			<tr>
